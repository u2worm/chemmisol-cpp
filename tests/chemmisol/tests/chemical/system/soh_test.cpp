...
TEST_F(SohTest, aqueous_and_mineral_species) {
...
TEST_F(SohTest, initial_mineral_concentrations) {
	...
	CHEM_LOGV(6) << "=SOH quantity: " << chemical_system.getSpecies("=SOH").quantity();
}
